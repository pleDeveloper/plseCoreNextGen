...
const NAV_ITEMS = [
    ...
    },
    {
        key: 'agent-roles',
        label: 'Agent roles',
        description: 'Manage the reusable agent roles workflows pick from — system prompts, tool allowlists, autonomy defaults.',
    ...
    },
    {
        key: 'email-routing',
        label: 'Email routing',
        description: 'Route inbound emails to the right Opportunity and manage routing rules.',
...
export default class PulseAdminStudio extends LightningElement {
    ...
    get isEmailRouting() {
        return this.activeNav === 'email-routing';
    }
    ...
    get isAgentRoles() {
        return this.activeNav === 'agent-roles';
    }
